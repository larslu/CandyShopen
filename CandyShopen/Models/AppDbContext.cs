...
namespace CandyShopen.Models
{
    public class AppDbContext : DbContext
    {
        ...
        {
            base.OnModelCreating(modelBuilder);//Skicka till basklassen

            modelBuilder.Entity<Category>().HasData(new Category
            { CategoryId = 1, CategoryName = "Chokladgodis" });

            modelBuilder.Entity<Category>().HasData(new Category
            { CategoryId = 2, CategoryName = "Fruktgodis" });

            modelBuilder.Entity<Category>().HasData(new Category
            { CategoryId = 3, CategoryName = "Wienergummi" });

            modelBuilder.Entity<Category>().HasData(new Category
            { CategoryId = 4, CategoryName = "Halloweengodis" });

            modelBuilder.Entity<Category>().HasData(new Category
            { CategoryId = 5, CategoryName = "Hårda karameller" });

            modelBuilder.Entity<Candy>().HasData(new Candy
            {
                CandyId = 1,
                Name = "Assorted Chocolat candy",
                Price = 4.95M,
                Description = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc et ex in dolor ultrices volutpat. Praesent tempor tempus risus nec gravida. Donec vel eros nisl. Praesent ultricies lorem a pharetra facilisis. Ut quis ex volutpat, bibendum massa eget, tempor nisi. Suspendisse vulputate ligula eros, et sagittis est egestas faucibus. Cras suscipit malesuada sagittis. Proin enim tortor, tincidunt id pharetra vitae, tristique laoreet purus. Ut dictum consectetur enim id malesuada. Donec vitae nisi vitae odio tincidunt iaculis. Maecenas sed hendrerit lorem. Nullam non vehicula arcu.",
                CategoryId = 1,
