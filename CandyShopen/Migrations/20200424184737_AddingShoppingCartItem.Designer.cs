...
namespace CandyShopen.Migrations
{
    ...
    [Migration("20200424184737_AddingShoppingCartItem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CandyShopen.Models.Candy", b =>
                {
            ...
            modelBuilder.Entity("CandyShopen.Models.Category", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasData(
                        ...
                        {
                            CategoryId = 1,
                            CategoryName = "Chokladgodis"
                        },
                        new
                        {
                            CategoryId = 2,
                            CategoryName = "Fruktgodis"
                        },
                        new
                        {
                            CategoryId = 3,
                            CategoryName = "Wienergummi"
                        },
                        new
                        {
                            CategoryId = 4,
                            CategoryName = "Halloweengodis"
                        },
                        new
                        {
                            CategoryId = 5,
                            CategoryName = "Hårda karameller"
                        });
                });

            modelBuilder.Entity("CandyShopen.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("CandyShopen.Models.Candy", b =>
                {
                    b.HasOne("CandyShopen.Models.Category", "Category")
                        .WithMany("Candies")
            ...
            modelBuilder.Entity("CandyShopen.Models.ShoppingCartItem", b =>
                {
                    b.HasOne("CandyShopen.Models.Candy", "Candy")
                        .WithMany()
